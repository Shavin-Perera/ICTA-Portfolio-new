...
export default function ReviewForm() {
  ...
  if (!isLoggedIn) {
    return (
      <div className="bg-gradient-to-br from-purple-900/80 to-indigo-900/80 rounded-lg p-8 text-center shadow-lg border border-white/10">
  ...
  return (
    <div className="bg-gradient-to-br from-purple-900/80 to-indigo-900/80 rounded-xl p-8 max-w-3xl mx-auto shadow-xl border border-white/10">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            value={reviewText}
            onChange={(e) => setReviewText(e.target.value)}
            className="w-full px-4 py-3 bg-white/15 border border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F4E007] text-white placeholder-white/60 text-lg"
